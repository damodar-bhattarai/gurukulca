...
if(!function_exists('siteLogoUrl')){
    function siteLogoUrl(){
        return Storage::url(config('appSettings.header_logo'));
    }
}
if(!function_exists('footerLogoUrl')){
    function footerLogoUrl(){
        return Storage::url(config('appSettings.footer_logo'));
    }
}

if(!function_exists('siteName')){
    function siteName(){
        return config('appSettings.site_name');
    }
}

if(!function_exists('faviconImageUrl')){
    function faviconImageUrl(){
        return Storage::url(config('appSettings.site_favicon'));
    }
}
if(!function_exists('getDeliveryInstructions')){
