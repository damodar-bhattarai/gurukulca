...
<div class="row mt-3">
    <div class="col-sm-6 col-md-3">
        ...
        <div class="card h-lg-100">
            ...
            <div class="card-body d-flex justify-content-between flex-column">
                <!--begin::Section-->
                <a href="{{ route('backend.user.index') }}" class="d-flex flex-column my-1">
                    <!--begin::Number-->
    ...
    <div class="col-sm-6 col-md-3">
        ...
        <div class="card h-lg-100">
            ...
            <div class="card-body d-flex justify-content-between flex-column">
                <!--begin::Section-->
                <a href="{{ route('backend.branch.index') }}" class="d-flex flex-column my-1">
                    <!--begin::Number-->
                    <span class="fw-bold fs-3x number-color lh-1 text-center">{{ $totalBranches }}</span>
                    <!--end::Number-->
                    <!--begin::Follower-->
                    <span class="fw-bold fs-6 text-color text-center">Total Branches</span>
                    <!--end::Follower-->
                </a>
                <!--end::Section-->
            </div>
    ...
    <div class="col-sm-6 col-md-3">
        ...
        <div class="card h-lg-100">
            ...
            <div class="card-body d-flex justify-content-between flex-column">
                <!--begin::Section-->
                <a href="{{ route('backend.orders.index') }}" class="d-flex flex-column my-1">
                    <!--begin::Number-->
    ...
    <div class="col-sm-6 col-md-3">
        ...
        <div class="card h-lg-100">
            ...
            <div class="card-body d-flex justify-content-between flex-column">
                <!--begin::Section-->
                <a href="{{ route('backend.user.requests') }}" class="d-flex flex-column my-1">
                    <!--begin::Number-->
                    <span class="fw-bold fs-3x number-color lh-1 text-center">{{ $totalUserRequest }}</span>
                    <!--end::Number-->
                    <!--begin::Follower-->
                    <span class="fw-bold fs-6 text-color text-center">Branch/Customer Request</span>
                    <!--end::Follower-->
                </a>
                <!--end::Section-->
            </div>
